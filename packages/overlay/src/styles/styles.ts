...
/* Sidebar mode menu positioning - near the FAB button */
...
/* Ensure menu is hidden by default in sidebar mode when not visible */
.three-lens-menu.sidebar-menu:not(.visible) {
...
.three-lens-metric-value.good { color: var(--3lens-success); }
.three-lens-metric-value.warning { color: var(--3lens-warning); }
.three-lens-metric-value.bad { color: var(--3lens-error); }
...
.three-lens-metrics-grid.three-lens-metrics-grid-compact {
...
.three-lens-benchmark-tab {
  display: flex;
  flex-direction: column;
  gap: 12px;
}

.three-lens-benchmark-summary {
  display: grid;
  grid-template-columns: repeat(4, minmax(0, 1fr));
  gap: 6px;
}

.three-lens-benchmark-summary-item {
  background: var(--3lens-bg-tertiary);
  border: 1px solid var(--3lens-border-subtle);
  border-radius: var(--3lens-radius-sm);
  padding: 6px 8px;
...
.three-lens-benchmark-summary-label {
  font-size: 8px;
  text-transform: uppercase;
  letter-spacing: 0.05em;
  color: var(--3lens-text-tertiary);
...
.three-lens-benchmark-summary-value {
  font-size: 13px;
  font-weight: 600;
  font-family: var(--3lens-font-mono);
  color: var(--3lens-text-primary);
...
.three-lens-benchmark-summary-value.good { color: var(--3lens-success); }
.three-lens-benchmark-summary-value.warning { color: var(--3lens-warning); }
.three-lens-benchmark-summary-value.bad { color: var(--3lens-error); }

.three-lens-benchmark-checks {
  display: grid;
  gap: 6px;
}

.three-lens-benchmark-check {
  display: flex;
  justify-content: space-between;
  align-items: center;
  background: var(--3lens-bg-secondary);
...
.three-lens-benchmark-check.good {
  border-left-color: var(--3lens-success);
}

.three-lens-benchmark-check.warning {
  border-left-color: var(--3lens-warning);
}

.three-lens-benchmark-check.bad {
  border-left-color: var(--3lens-error);
}

.three-lens-benchmark-pill {
  font-family: var(--3lens-font-mono);
  font-size: 10px;
  color: var(--3lens-text-primary);
}
...
.three-lens-sidebar.resizing {
  transition: none !important;
}

.three-lens-sidebar.sidebar-right {
  right: 0;
  border-left: 1px solid var(--3lens-border);
  box-shadow: -4px 0 12px rgba(0, 0, 0, 0.3);
}

.three-lens-sidebar.sidebar-left {
  left: 0;
  border-right: 1px solid var(--3lens-border);
  box-shadow: 4px 0 12px rgba(0, 0, 0, 0.3);
}

.three-lens-sidebar.collapsed {
  width: 50px;
}
...
.three-lens-sidebar-resize-handle:hover {
  background: var(--3lens-accent-cyan);
  opacity: 0.5;
}

.three-lens-sidebar-resize-handle:active {
  background: var(--3lens-accent-cyan);
  opacity: 0.8;
}

.three-lens-sidebar-toggle {
  position: absolute;
  top: 50%;
...
.three-lens-sidebar.sidebar-right .three-lens-sidebar-toggle {
  left: -20px;
  border-right: none;
  border-radius: var(--3lens-radius-md) 0 0 var(--3lens-radius-md);
}

.three-lens-sidebar.sidebar-left .three-lens-sidebar-toggle {
  right: -20px;
  border-left: none;
  border-radius: 0 var(--3lens-radius-md) var(--3lens-radius-md) 0;
}

.three-lens-sidebar-toggle:hover {
  background: var(--3lens-bg-hover);
  color: var(--3lens-accent-cyan);
}
...
.three-lens-sidebar.collapsed .three-lens-sidebar-panels {
  flex: 1;
  padding: 8px 4px;
  align-items: center;
  justify-content: center;
...
.three-lens-sidebar-panels.drag-over {
  background: rgba(34, 211, 238, 0.1);
  border: 2px dashed var(--3lens-accent-cyan);
}

.three-lens-sidebar-panel-item {
  display: flex;
  align-items: center;
  gap: 10px;
  padding: 8px 12px;
...
.three-lens-sidebar.collapsed .three-lens-sidebar-panel-item {
  justify-content: center;
  align-items: center;
  padding: 8px;
  gap: 0;
...
.three-lens-sidebar-panel-item:hover {
  background: var(--3lens-bg-hover);
}

.three-lens-sidebar-panel-item.active {
  background: rgba(34, 211, 238, 0.15);
  color: var(--3lens-accent-cyan);
}

.three-lens-sidebar-panel-item.docked {
  background: rgba(34, 211, 238, 0.2);
  border: 1px solid var(--3lens-accent-cyan);
}

.three-lens-sidebar-panel-item.dragging {
  opacity: 0.5;
}

.three-lens-sidebar-panel-icon {
  width: 24px;
  height: 24px;
  display: flex;
  align-items: center;
...
.three-lens-sidebar.collapsed .three-lens-sidebar-panel-icon {
  margin: 0;
  display: flex;
  align-items: center;
  justify-content: center;
...
.three-lens-sidebar-panel-item.active .three-lens-sidebar-panel-icon,
.three-lens-sidebar-panel-item.docked .three-lens-sidebar-panel-icon {
  color: var(--3lens-accent-cyan);
}

.three-lens-sidebar-panel-title {
  flex: 1;
  font-size: 13px;
  overflow: hidden;
  text-overflow: ellipsis;
...
.three-lens-sidebar.collapsed .three-lens-sidebar-panel-title {
  display: none;
}
...
.three-lens-sidebar-panel-item:hover .three-lens-sidebar-panel-popout,
.three-lens-sidebar-panel-item.docked .three-lens-sidebar-panel-popout {
  opacity: 1;
}

.three-lens-sidebar-panel-popout:hover {
  background: var(--3lens-bg-hover);
  color: var(--3lens-accent-cyan);
}

.three-lens-sidebar.collapsed .three-lens-sidebar-panel-popout {
  display: none;
}

.three-lens-sidebar.drag-target {
  border-left-color: var(--3lens-accent-cyan);
  box-shadow: -4px 0 12px rgba(34, 211, 238, 0.4);
}

.three-lens-sidebar-fab {
  position: fixed;
  bottom: 20px;
  left: 20px;
  width: 36px;
...
.three-lens-sidebar-fab svg {
  width: 20px;
  height: 20px;
}

.three-lens-sidebar-fab:hover {
  transform: scale(1.1);
  border-color: var(--3lens-accent-cyan);
  box-shadow: var(--3lens-shadow-lg), 0 0 30px rgba(34, 211, 238, 0.4);
}

.three-lens-sidebar-fab:active {
  transform: scale(0.95);
}

.three-lens-sidebar-panels::-webkit-scrollbar {
  width: 6px;
}

.three-lens-sidebar-panels::-webkit-scrollbar-track {
  background: transparent;
}

.three-lens-sidebar-panels::-webkit-scrollbar-thumb {
  background: var(--3lens-border);
  border-radius: 3px;
}

.three-lens-sidebar-panels::-webkit-scrollbar-thumb:hover {
  background: var(--3lens-text-tertiary);
}

/* ═══════════════════════════════════════════════════════════════
   SIDEBAR TOP BAR (for docked panels, like VS Code)
   ═══════════════════════════════════════════════════════════════ */

.three-lens-sidebar-topbar {
  position: relative;
  height: 40px;
  background: var(--3lens-bg-primary);
  border-bottom: 1px solid var(--3lens-border);
...
.three-lens-sidebar.collapsed .three-lens-sidebar-topbar {
  display: none;
}
...
.three-lens-sidebar.collapsed .three-lens-sidebar-panel-content {
  display: none;
}
...
.three-lens-topbar-icon:hover {
  background: var(--3lens-bg-hover);
  color: var(--3lens-text-primary);
}

.three-lens-topbar-icon.active {
  background: rgba(34, 211, 238, 0.15);
  color: var(--3lens-accent-cyan);
}

.three-lens-topbar-dropdown {
  position: relative;
  flex-shrink: 0;
}
...
.three-lens-topbar-dropdown-toggle:hover {
  background: var(--3lens-bg-hover);
  color: var(--3lens-text-primary);
}

.three-lens-topbar-dropdown-toggle svg {
  transition: transform 0.15s ease;
}

.three-lens-topbar-dropdown:has(.three-lens-topbar-dropdown-menu.visible) .three-lens-topbar-dropdown-toggle svg {
  transform: rotate(180deg);
}

.three-lens-topbar-dropdown-menu {
  position: fixed;
  background: var(--3lens-bg-primary);
  border: 1px solid var(--3lens-border);
  border-radius: var(--3lens-radius-sm);
...
.three-lens-topbar-dropdown-menu.visible {
  display: flex;
}

.three-lens-topbar-dropdown-item {
  display: flex;
  align-items: center;
  gap: 10px;
  padding: 6px 10px;
...
.three-lens-topbar-dropdown-item:hover {
  background: var(--3lens-bg-hover);
}

.three-lens-topbar-dropdown-item.active {
  background: rgba(34, 211, 238, 0.15);
  color: var(--3lens-accent-cyan);
}

.three-lens-topbar-dropdown-item span {
  flex: 1;
  overflow: hidden;
  text-overflow: ellipsis;
  white-space: nowrap;
...
.three-lens-bottom-bar {
  ...
  border-radius: var(--3lens-radius-xl) var(--3lens-radius-xl) 0 0;
}

.three-lens-bottom-bar.collapsed {
  height: 50px;
}

.three-lens-bottom-bar-toggle {
  position: absolute;
  top: -24px;
  left: 50%;
  transform: translateX(-50%);
  ...
  border: 1px solid var(--3lens-border);
  border-bottom: none;
  border-radius: var(--3lens-radius-lg) var(--3lens-radius-lg) 0 0;
  cursor: pointer;
  display: flex;
  align-items: center;
  justify-content: center;
...
.three-lens-bottom-bar-toggle:hover {
  background: var(--3lens-bg-hover);
  color: var(--3lens-accent-cyan);
}

.three-lens-bottom-bar-toggle::before {
  content: '';
  position: absolute;
  top: 8px;
  left: 50%;
